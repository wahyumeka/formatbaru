        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <a href="#"><img src="https://upload.wikimedia.org/wikipedia/id/thumb/1/1b/Pusterad.png/200px-Pusterad.png" style="width: 72px; height: 72px;" alt="" /></a>
                    </div>
                </div>
                            ...
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" data-target="#demoevent" href="#">Email</a>
                                    <ul id="demoevent" class="collapse dropdown-header-top">
                                        <li><a href="inbox.html">Lihat Data</a></li>li
                                        <li><a href="view-email.html">Tambah </a></li>
                                        <!-- <li><a href="compose-email.html">Compose Email</a></li> -->
                                    </ul>
                                </li>
                                <li><a data-toggle="collapse" data-target="#democrou" href="#">Interface</a>
                                    <ul id="democrou" class="collapse dropdown-header-top">
                                        <li><a href="animations.html">Upload Data</a></li>
                                        <li><a href="google-map.html">Lihat Data</a></li>
                                        <li><a href="data-map.html">Tambah Data</a></li>
                                ...
                                <li><a data-toggle="collapse" data-target="#demolibra" href="#">Charts</a>
                                    <ul id="demolibra" class="collapse dropdown-header-top">
                                        <li><a href="flot-charts.html">Tambah Data</a></li>
                                        <li><a href="bar-charts.html">Lihat Data</a></li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-edit"></i> Data Personil</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="mailbox" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li><a href="add._user.php">Tambah</a>
                                </li>
